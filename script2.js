function adicionarItem() {
    ...
    if (textoItem !== '' && input2 !==''){
        ...
        else if(input2 == 'laranja'){
            novoItem.classList.add('laranja')
        }
        else if(input2 == 'amarelo'){
            novoItem.classList.add('amarelo')
        }
        else if(input2 == 'verde'){
            novoItem.classList.add('verde')
        }
        else if(input2 == 'azul'){
            novoItem.classList.add('azul')
        }
